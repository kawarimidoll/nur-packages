...
|---------|---------|-------------|
| difit | v5.0.11 | A lightweight CLI tool to display Git diffs in GitHub-style web viewer |
| fff-mcp | 0.10.3 | The fastest and most accurate file search toolkit for AI agents (MCP server) |
...
| lightpanda | 0.3.6 | Lightweight browser engine for AI agents and web automation |
...
| zmx | 0.7.0 | Session attach/detach for the terminal |
<!-- packages-table-end -->
