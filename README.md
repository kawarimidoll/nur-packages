...
| fff-mcp | 0.11.0 | The fastest and most accurate file search toolkit for AI agents (MCP server) |
...
| lightpanda | 0.4.1 | Lightweight browser engine for AI agents and web automation |
