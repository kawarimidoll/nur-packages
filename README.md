...
|---------|---------|-------------|
| difit | v4.0.4 | A lightweight CLI tool to display Git diffs in GitHub-style web viewer |
...
| lightpanda | 0.2.9 | Lightweight browser engine for AI agents and web automation |
